...
| CI/CD・デプロイ | 学習中 | GitHub ActionsとRulesetに加え、EC2上でDocker Composeを使ってFastAPI・PostgreSQLを起動。外部HTTP接続、DB書き込み、EC2停止・再起動後の復旧、DB永続化、パブリックIPv4変化、IAM最小権限化を確認。HTTPSとバックアップは今後確認 |
