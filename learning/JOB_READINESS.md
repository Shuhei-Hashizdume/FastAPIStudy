...
| CI/CD・デプロイ | 学習中 | GitHub ActionsとRuleset、EC2上のDocker ComposeによるFastAPI・PostgreSQL配置、停止・復旧、DB永続化、IAM最小権限化を確認。CaddyのTLS終端、HTTPリダイレクト、内部CAの証明書検証、API 8000番の外部遮断も実測。ドメインと公的CA、バックアップ、監視は今後確認 |
